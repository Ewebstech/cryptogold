...
<div class="module module-consultation pull-left">
	<a href="page-consultation.html" class="btn btn--primary btn--bordered btn--rounded">get A Quote</a>
</div>				<!-- Module Signup  -->
			...
			<ul> 
				...
				<li data-transition="slidedown"
					...
					<div class="tp-caption" 
                        ...
                        data-y="['middle','middle','middle','middle']" data-voffset="['-60','-60','-50','-20']"
                        ...
                        data-responsive_offset="on">
 						<div class="slide--headline text-center">We Provide Professional <br>Market Infrastructure Firms</div>
  					</div>
					
					<!-- LAYER NR. 2 -->
					<div class="tp-caption" 
				        data-x="['center','center','center','center']" data-hoffset="['0','0','0','0']" 
                        data-y="['middle','middle','middle','middle']" data-voffset="['45','45','45','30']"
						...
						data-splitout="none" 
						data-responsive_offset="on">
 						<div class="slide--bio text-center">We Are The Leaders Of Financial Investment Market!</div>
					...
					<div class="tp-caption" 
				        data-x="['center','center','center','center']" data-hoffset="['0','0','0','0']" 
                        data-y="['middle','middle','middle','middle']" data-voffset="['120','120','120','150']"
						data-width="none"
						data-height="none"
						data-whitespace="nowrap"
						...
						<div class="slide-action">
							<a class="btn btn--gradient btn--rounded" href="#">Get Started</a>
 						</div>
					</div>
				</li>
				...
				<li data-transition="slidingoverlayleft" 
					...
					data-masterspeed="2000">
					<!-- MAIN IMAGE -->
					<img src="assets/images/sliders/slide-bg/6.jpg" alt="Slide Background Image"  width="1920" height="1280">
					<!-- LAYER NR. 1 -->
					<div class="tp-caption" 
				        data-x="['center','center','center','center']" data-hoffset="['0','0','0','0']" 
						...
						data-width="none"
						data-height="none"
                        data-frames='[{"delay":1000,"speed":1500,"frame":"0","from":"x:[175%];y:0px;z:0;rX:0;rY:0;rZ:0;sX:1;sY:1;skX:0;skY:0;opacity:1;","mask":"x:[-100%];y:0;s:inherit;e:inherit;","to":"o:1;","ease":"Power3.easeOut"},{"delay":"wait","speed":300,"frame":"999","to":"auto:auto;","ease":"Power3.easeInOut"}]' 						data-splitin="none" 
						data-splitout="none" 
						data-responsive_offset="on">
					...
					<div class="tp-caption" 
						...
						data-width="none"
						data-height="none"
                        data-frames='[{"delay":1500,"speed":2500,"frame":"0","from":"x:[-175%];y:0px;z:0;rX:0;rY:0;rZ:0;sX:1;sY:1;skX:0;skY:0;opacity:1;","mask":"x:[100%];y:0;s:inherit;e:inherit;","to":"o:1;","ease":"Power3.easeOut"},{"delay":"wait","speed":300,"frame":"999","to":"auto:auto;","ease":"Power3.easeInOut"}]' 						data-splitin="none" 
						data-splitout="none" 
						data-responsive_offset="on">
 						<div class="slide--headline text-center">Start Trading The World's Most <br>Popular Cryptocurrencies!</div>
 					</div>		
					...
					<div class="tp-caption" 
						...
						data-width="none"
						data-height="none"
                        data-frames='[{"delay":1500,"speed":200,"frame":"0","from":"y:[-100%];z:0;rX:0deg;rY:0;rZ:0;sX:1;sY:1;skX:0;skY:0;","mask":"x:0px;y:0px;s:inherit;e:inherit;","to":"o:1;","ease":"Power3.easeInOut"},{"delay":"wait","speed":300,"frame":"999","to":"auto:auto;","ease":"Power3.easeInOut"}]' 						data-splitin="none" 
						data-splitout="none" 
						data-responsive_offset="on">
					...
					<div class="tp-caption" 
				        data-x="['center','center','center','center']" data-hoffset="['0','0','0','0']" 
                        data-y="['middle','middle','middle','middle']" data-voffset="['170','170','180','260']"
						data-height="none"
						data-whitespace="nowrap"
				...
				<li data-transition="slotslide-horizontal"
					...
					<div class="tp-caption" 
						...
						data-width="none"
						data-height="none"
                        data-frames='[{"delay":750,"speed":1500,"frame":"0","from":"x:[-100%];z:0;rX:0deg;rY:0;rZ:0;sX:1;sY:1;skX:0;skY:0;","mask":"x:0px;y:0px;s:inherit;e:inherit;","to":"o:1;","ease":"Power3.easeInOut"},{"delay":"wait","speed":300,"frame":"999","to":"auto:auto;","ease":"Power3.easeInOut"}]'						data-splitout="none" 
						data-responsive_offset="on">
					...
					<div class="tp-caption" 
                        ...
                        data-frames='[{"delay":1500,"speed":2000,"frame":"0","from":"z:0;rX:0deg;rY:0;rZ:0;sX:2;sY:2;skX:0;skY:0;opacity:0;","mask":"x:0px;y:0px;s:inherit;e:inherit;","to":"o:1;","ease":"Power2.easeOut"},{"delay":"wait","speed":300,"frame":"999","to":"auto:auto;","ease":"Power3.easeInOut"}]'						data-splitin="none" 
						data-splitout="none" 
						data-responsive_offset="on">
					...
					<div class="tp-caption" 
						...
						data-height="none"
						data-whitespace="nowrap"
                        data-frames='[{"delay":1500,"speed":1500,"frame":"0","from":"y:bottom;rX:-20deg;rY:-20deg;rZ:0deg;","to":"o:1;","ease":"Power3.easeOut"},{"delay":"wait","speed":300,"frame":"999","to":"auto:auto;","ease":"Power3.easeInOut"}]' 						data-splitin="none" 
						data-splitout="none" 
 						data-basealign="slide" 
						data-responsive_offset="on" 
						data-responsive="off">
...
<!-- Featured #2 
============================================= -->
<section id="featured2" class="featured featured-2 text-center pb-50">
	<div class="container">
...
<!-- Video Button
============================================= -->
<section id="video" class="video-button pb-0">
   <div class="bg-section">
    ...
    <div class="container">
			...
			<div class="col-xs-12 col-sm-12 col-md-8 col-md-offset-2">
				<div class="heading heading-5 mb-120 text--center">
					<p class="heading--subtitle">Profitable And Successful Investments</p>
					<h2 class="heading--title text-white">Internal Accounting, Sales Data & Market Economic Indicators</h2>
 				</div>
			</div><!-- .col-md-6 end -->
		</div><!-- .row end -->
        <div class="row">
             <div class="col-xs-12 col-sm-12 col-md-12">
				<div class="video--content text-center">
					<div class="bg-section">
						<img src="assets/images/video/3.jpg" alt="Background" />
					</div>
...
<!-- Info Cards
============================================= -->
<section id="infoCards" class="info-cards bg-gray pt-70">
	<div class="container">
		<div class="row">
...
<!-- Pricing Table #1
============================================= -->
<section id="pricing1" class="pricing pricing-1 pb-80">
<div class="bg-section">
		...
		<div class="row">
			...
			<div class="case-item filter-Investment">
				...
				<div class="case--content">
					...
					<div class="case--title">
						<h4><a href="#">33 Cases: Cryptocurrency Fraud Is on the Rise in Japan</a></h4>
					</div>
				</div>
				</div>
			</div><!-- . case-item end -->
			...
			<div class="case-item-container">
				...
				<div class="case--content">
					...
					<div class="case--title">
						<h4><a href="#">Research Perspectives & Challenges for Cryptocurrencies Authors</a></h4>
					</div>
				</div>
				</div>
			</div><!-- . case-item end -->
			...
			<div class="case-item-container">
				...
				<div class="case--content">
					...
					<div class="case--title">
						<h4><a href="#">Ripple’s Giving the Third-Largest Cryptocurrency a Second Look</a></h4>
					</div>
				</div>
				</div>
			</div><!-- . case-item end -->
			...
			<div class="case-item-container">
				...
				<div class="case--content">
					...
					<div class="case--title">
						<h4><a href="#">Bitcoin’s Price Surge is Making Hobby Mining Profitable Again</a></h4>
					</div>
				</div>
				</div>
			</div><!-- . case-item end -->
...
<script src="assets/js/widgets.html"></script>
